import { ChartColumnBig, ChartSpline, Users } from "lucide-react";
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow sm:col-span-2 lg:col-span-1">
          <div className="flex items-center justify-between">
            ...
            <div className="text-3xl sm:text-4xl"><ChartColumnBig /></div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-4 sm:p-6 rounded-lg shadow">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <button onClick={() => navigate('/data')} className="p-3 sm:p-4 cursor-pointer border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left">
